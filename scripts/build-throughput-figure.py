...
NARROW_OUT = ROOT / "assets" / "figures" / "throughput-box-narrow.svg"
...
def render(W, PLOT_X0, PLOT_X1, Y_MID, Y_AXIS, narrow=False):
    ...
    svg = f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="100%"
     class="fig-thru{" narrow" if narrow else ""}" role="img" aria-labelledby="thruTitle thruDesc"
  ...
  <text class="lab" x="0" y="{LAB_Y1}">Respondents recruited</text>
  <text class="lab" x="0" y="{LAB_Y2}">per active day</text>
